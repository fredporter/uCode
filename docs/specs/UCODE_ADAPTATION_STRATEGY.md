...
| ----------- | ---------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------- |
| ACS         | Rewrite (uCode inspired-by)  | Original source unavailable; design is iconic     | Native GridCore UI + LENS + SKIN + control with Inspire-Engine                 |
| Eamon       | Adapt original source (port) | Applesoft source available and modular            | LENS for stats/state, SKIN themes, control save/load tooling                   |
| Apple Panic | Rewrite (uCode inspired-by)  | Original source unavailable                       | Native GridCore character objects, LENS level state, control control           |
| Elite       | Adapt original source        | 6502 source available and documented              | LENS ship/cargo/location, SKIN wireframe themes, control control hooks         |
...
| Knight Orc  | Rewrite (uCode inspired-by)  | Original KAOS engine source not readily available | Text parser with GridCore teletext, LENS time/NPC state, control time controls |
...
5. control supports SAVE/LOAD/EXPORT/DEBUG flows.
...
5. control reset/skip/pause commands.
...
5. control save/load/time-control commands.
...
| Command-Scribe     | Define command/control interfaces                                  |
...
| --------------------------- | --------------------- | ---------------------------------------------------- |
| Original source available   | Adapt original source | Source-Miner, LENS-Craft, Command-Scribe                 |
| Original source unavailable | Inspired-by rewrite   | Inspire-Engine, uCode-Weaver, LENS-Craft, Command-Scribe |
| Source unclear/complex      | Inspired-by rewrite   | Inspire-Engine, uCode-Weaver, LENS-Craft, Command-Scribe |
